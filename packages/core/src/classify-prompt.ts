...
export const TAXONOMY_PREFIX = [
  ...
  "- ohmail/News: newsletters, marketing, bulk/list mail to skim.",
...
export const SCREENING_PREFIX = [
  ...
  "  system, and they belong in ohmail/News. Do not promote one because ignoring it would have a",
  ...
  "- ohmail/News: newsletters, marketing the person signed up for, announcements, bulk or list",
