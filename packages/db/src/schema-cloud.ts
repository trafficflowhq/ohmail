...
export const authEvents = pgTable("auth_events", {
  ...
  event: text("event").notNull(),                  // AuthAuditEvent["event"] — login|login_failed|2fa_verified|2fa_failed|logout|device_revoked|recovery_used|lockout|enrollment_started|email_verified|desktop_link_issued|refresh_reuse_revoked|refresh_recovered|refresh_retry_replayed
