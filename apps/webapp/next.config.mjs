 ...
 */
/*
 * There was a second build-time fetch here — the newest `android-v*` tag, inlined for the
 * download section's Android button. It is gone: the APK is an asset of the stable release
 * now, so the button links it through `latest` like every other download and no build has
 * to know a version. `app/(marketing)/downloads.ts` carries the reasoning.
 */
