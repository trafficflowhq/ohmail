 ...
 * the request down unspendable and sends the browser here. One parameter is read, and it is a
 * HANDLE rather than a credential — only the session that opened the request can confirm it.
 * Shape-checked and dropped to the empty string otherwise; repeated values take the FIRST.
 */
