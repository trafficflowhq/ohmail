 ...
 * fields; the shell's per-reply state), never globally: a removal belongs to one message.
 *
 ...
 */
export function withSignature<M extends Pick<MailSend, "body" | "html">>(m: M, sig: string | null): M {
