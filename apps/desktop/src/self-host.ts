 ...
 * candidate probe loads `cloud-ca.pem` from the shell's path at the moment it dials, rather than
 * inheriting whatever roots the running engine was launched with (`operator-ca-fetch.ts`).
 */
