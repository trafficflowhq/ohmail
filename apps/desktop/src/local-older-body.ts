 ...
 * `olderBodyVia` (`@ohmail/client-engine`), which the LAN host client's bearer transport imports
 * from there directly (`host-client/transports.ts`); this file supplies only `bridgeFetch`.
 *
